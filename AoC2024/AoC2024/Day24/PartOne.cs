...
{ 
    private Dictionary<string, bool> _register = new(); 
    ...
    public override long Solve()
    {
        ...
        while (operations.Count > 0)
        {
            ...
            if (_register.TryGetValue(currOperation.WireA, out var wireA) && _register.TryGetValue(currOperation.WireB, out var wireB))
            {
