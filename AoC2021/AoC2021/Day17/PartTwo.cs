...
public class PartTwo(string input) : Solution(input)
{
    public override long Solve()
    {
        ...
        for (var xStartVelocity = 22; xStartVelocity <= 273; xStartVelocity++)
        {
            for (var yStartVelocity = -97; yStartVelocity <= 96; yStartVelocity++)
            {
                ...
                if (isScored)
                {
                    initialVelocityScored++;

                    //if(xMaxScored < xStartVelocity)
                    //    xMaxScored = xStartVelocity;
                    //if(yMaxScored  < yStartVelocity)
                    //    yMaxScored = yStartVelocity;
                    //if(xMinScored > xStartVelocity)
                    //    xMinScored = xStartVelocity;
                    //if(yMinScored > yStartVelocity)
                    //    yMinScored = yStartVelocity;
                }
            }
        }

        return initialVelocityScored;
    }
}